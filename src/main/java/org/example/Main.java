...
import org.example.serialization.AlertSerializer;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Pattern<CreditCardTransaction, ?> pattern = Pattern
            ...
            .where(new SimpleCondition<CreditCardTransaction>() {
                @Override
            ...
            .within(org.apache.flink.streaming.api.windowing.time.Time.minutes(1)); // 1 分钟内
